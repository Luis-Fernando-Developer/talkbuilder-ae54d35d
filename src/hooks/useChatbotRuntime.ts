...
const RUNTIME_URL = import.meta.env.VITE_RUNTIME_URL || `${import.meta.env.VITE_SUPABASE_URL || "https://xllkibdddlmcdbrhzedu.supabase.co"}/functions/v1/chatbot-runtime`;
